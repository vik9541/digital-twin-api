...
INTENT_KEYWORDS = {
    ...
    Intent.CONTACT: {
        'high': [
            'контакт', 'контакты', 'номер', 'телефон',
            'добавь контакт', 'сохрани контакт', 'запиши номер',
            'найди контакт', 'покажи контакты',
            'позвонить', 'телефонная книга',
        ],
        'medium': [
            'номер телефона', 'чей номер', 'чей телефон',
        ],
    },
}
